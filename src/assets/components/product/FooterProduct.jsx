...
const Footer = () => (
    <footer className="w-full bg-black text-gray-300 pt-12">
        <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
                {/* Columna de la marca */}
                <div className="md:col-span-1 mb-6 md:mb-0">
                    <h3 className="font-black text-2xl text-white tracking-wider mb-4">MAJUVE</h3>
                    <p className="text-sm">¡Tu poder está en tu look!</p>
                </div>
                {/* Columnas de enlaces */}
                <div>
                    <h4 className="font-bold uppercase text-white mb-4">Sobre la marca</h4>
                    <a href="#" className="block mb-2 hover:text-pink-300 transition">Nosotros</a>
                    <a href="#" className="block mb-2 hover:text-pink-300 transition">Cultura</a>
                    <a href="#" className="block mb-2 hover:text-pink-300 transition">Trabaja aquí</a>
                </div>
                <div>
                    <h4 className="font-bold uppercase text-white mb-4">Ayuda</h4>
                    <a href="#" className="block mb-2 hover:text-pink-300 transition">Envíos</a>
                    <a href="#" className="block mb-2 hover:text-pink-300 transition">Seguimiento</a>
                    <a href="#" className="block mb-2 hover:text-pink-300 transition">Preguntas Frecuentes</a>
                </div>
                 <div>
            ...
            <div className="mt-8 py-4 border-t border-gray-700 text-center text-sm">
                <p>&copy; {new Date().getFullYear()} MAJUVE. Todos los derechos reservados.</p>
